...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + Objects.hashCode(this.dataInicial);
        hash = 31 * hash + Objects.hashCode(this.dataFinal);
        hash = 31 * hash + Objects.hashCode(this.devsInscritos);
        hash = 31 * hash + Objects.hashCode(this.conteudos);
        return hash;
    }
